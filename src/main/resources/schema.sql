...
CREATE TABLE IF NOT EXISTS FILMS (
	...
	CONSTRAINT FILMS_FK FOREIGN KEY (RATING_MPA_ID) REFERENCES RATING_MPA(RATING_MPA_ID) ON DELETE RESTRICT ON UPDATE RESTRICT
);
...
CREATE TABLE IF NOT EXISTS FILMS_TO_GENRES (
	...
	CONSTRAINT FILMS_TO_GENRES_FK FOREIGN KEY (FILM_ID) REFERENCES FILMS(FILM_ID) ON DELETE RESTRICT ON UPDATE RESTRICT,
    CONSTRAINT FILMS_TO_GENRES_FK_1 FOREIGN KEY (GENRE_ID) REFERENCES GENRE(GENRE_ID) ON DELETE RESTRICT ON UPDATE RESTRICT
);
...
CREATE TABLE IF NOT EXISTS LIKED_FILMS (
	USER_ID INTEGER,
	FILM_ID INTEGER,
	CONSTRAINT LIKED_FILMS_FK FOREIGN KEY (USER_ID) REFERENCES USERS(USER_ID) ON DELETE RESTRICT ON UPDATE RESTRICT,
    CONSTRAINT LIKED_FILMS_FK_1 FOREIGN KEY (FILM_ID) REFERENCES FILMS(FILM_ID) ON DELETE RESTRICT ON UPDATE RESTRICT
);
...
CREATE TABLE IF NOT EXISTS FRIENDS_LIST (
	...
	CONSTRAINT FRIENDS_LIST_FK FOREIGN KEY (FRIENDSHIP_STATUS_ID) REFERENCES FRIENDSHIP_STATUS(FRIENDSHIP_STATUS_ID) ON DELETE RESTRICT ON UPDATE RESTRICT,
    CONSTRAINT FRIENDS_LIST_FK_1 FOREIGN KEY (USER_ID) REFERENCES USERS(USER_ID) ON DELETE RESTRICT ON UPDATE RESTRICT,
    CONSTRAINT FRIENDS_LIST_FK_2 FOREIGN KEY (FRIEND_ID) REFERENCES USERS(USER_ID) ON DELETE RESTRICT ON UPDATE RESTRICT
);
